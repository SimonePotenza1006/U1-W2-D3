const starWarsCharacters = [
  ...
  */
    ...
    for (let i=0; i < starWarsCharacters.length; i++) {
        if(
            ...
            femaleCharacters.push("Name:", starWarsCharacters[i].name, "hair color", starWarsCharacters[i].hair_color, "eye color", starWarsCharacters[i].eye_color)
        }
    }
  ...
  */
    ...
    for(let i=0; i < starWarsCharacters.length; i++) {
        switch(starWarsCharacters[i].eye_color){
            ...
            break
            case "blue-gray":
                eyeColor.blue_gray.push(["Name:" + starWarsCharacters[i].name])
            break
  ...
  */
    ...
    while(m < starWarsCharacters.length){
        crewMass +=
        Number(starWarsCharacters[m].mass)
        m++
    }
